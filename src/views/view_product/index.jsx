...
const ViewProduct = () => {
  ...
  const [stok, setStok] = useState(product?.maxQuantity || "");
  ...
  //   db.collection("products").doc(id).update({ maxQuantity: stokBaru });
  // };
        ...
        <div className="product-view">
          ...
          <div className="product-modal">
            ...
            <div className="product-modal-details">
              ...
              <h3>
                Stok Produk: <b>{product?.maxQuantity}</b>
                {/* <button onClick={updateStok}>Test</button> */}
