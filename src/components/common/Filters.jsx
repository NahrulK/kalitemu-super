      ...
      <div className="filters-field">
        ...
        {products.length === 0 && isLoading ? (
          ...
          >
            ...
            <option value="salt">Amaq Mahrip</option>
            <option value="betsin">Hj Haeruman</option>
            <option value="black">Mik Bahar</option>
            <option value="sexbomb">Tuan Apar</option>
          </select>
        )}
      </div>
      <div className="filters-field">
        ...
        >
          ...
          <option value="name-asc">Urutkan dari A ke Z</option>
          <option value="name-desc">Urutkan dari Z - A</option>
          <option value="price-desc">Harga Tertinggi - Terendah</option>
          <option value="price-asc">Price Terendah - Tertinggi</option>
        </select>
      </div>
      <div className="filters-field">
