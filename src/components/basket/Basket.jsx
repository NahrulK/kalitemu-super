  ...
  return user && user.role === "ADMIN" ? null : (
    <Boundary>
      <Modal isOpen={isOpenModal} onRequestClose={onCloseModal}>
        <p className="text-center">Masuk untuk melakukan Checkout</p>
        <br />
      ...
      <div className="basket">
        <div className="basket-list">
          ...
          {basket.length <= 0 && (
            <div className="basket-empty">
              <h5 className="basket-empty-msg">Keranjang anda Kosong 💛 </h5>
            </div>
          )}
        ...
        <div className="basket-checkout">
          <div className="basket-total">
            <p className="basket-total-title">Total Belanja:</p>
